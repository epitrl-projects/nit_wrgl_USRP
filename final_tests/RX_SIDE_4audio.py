...
import RX_SIDE_4audio_epy_block_0_0 as epy_block_0_0  # embedded python block
import RX_SIDE_4audio_epy_block_1 as epy_block_1  # embedded python block



from gnuradio import qtgui

class RX_SIDE_4audio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RX_SIDE_4audio")
        ...
        self.central_freq_0 = central_freq_0 = 915e6
        self.central_freq = central_freq = 915e6
        self.TX_GAIN = TX_GAIN = 40
        self.RX_GAIN_0 = RX_GAIN_0 = 40
        ...
        self._variable_qtgui_chooser_0_labels = ['song0', 'song1', 'song2']
        ...
        self._samp_rate_0_range = Range(0, 500000, 1, 100000, 200)
        self._samp_rate_0_win = RangeWidget(self._samp_rate_0_range, self.set_samp_rate_0, "RX_SAMPLE", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._samp_rate_0_win)
        self._samp_rate_range = Range(0, 500000, 1, 100000, 200)
        self._samp_rate_win = RangeWidget(self._samp_rate_range, self.set_samp_rate, "TX_SAMPLE", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._samp_rate_win)
        self._central_freq_0_range = Range(915e6, 10000e6, 1e6, 915e6, 200)
        self._central_freq_0_win = RangeWidget(self._central_freq_0_range, self.set_central_freq_0, "RX_FREQ", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._central_freq_0_win)
        self._RX_GAIN_0_range = Range(0, 1000, 1, 40, 200)
        self._RX_GAIN_0_win = RangeWidget(self._RX_GAIN_0_range, self.set_RX_GAIN_0, "RX_GAIN", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.uhd_usrp_source_0.set_center_freq(central_freq_0, 0)
        self.uhd_usrp_source_0.set_antenna("RX2", 0)
        self.uhd_usrp_source_0.set_rx_agc(False, 0)
        self.uhd_usrp_source_0.set_gain(RX_GAIN_0, 0)
        ...
        self.uhd_usrp_sink_0.set_center_freq(107.0e6, 0)
        ...
        self.epy_block_1 = epy_block_1.int8_to_message(chooser_block=variable_qtgui_chooser_0)
        self.epy_block_0_0 = epy_block_0_0.myblock(folder_path="/home/pi/Desktop/project/assets")
        ...
        self._central_freq_range = Range(915e6, 10000e6, 1e6, 915e6, 200)
        self._central_freq_win = RangeWidget(self._central_freq_range, self.set_central_freq, "TX FREQ", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_stream_to_tagged_stream_1 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 96, "packet_len")
        ...
        self._TX_GAIN_range = Range(10, 1000, 1, 40, 200)
        ...
        self.msg_connect((self.epy_block_1, 'msg_out'), (self.epy_block_0_0, 'weight_msg'))
        ...
        self.connect((self.blocks_stream_to_tagged_stream_1, 0), (self.epy_block_1, 0))
        ...
        self.connect((self.epy_block_0_0, 0), (self.analog_wfm_tx_0, 0))
    ...
    def set_variable_qtgui_chooser_0(self, variable_qtgui_chooser_0):
        ...
        self._variable_qtgui_chooser_0_callback(self.variable_qtgui_chooser_0)
        self.epy_block_1.chooser_block = self.variable_qtgui_chooser_0
    ...
    def get_central_freq_0(self):
        return self.central_freq_0

    def set_central_freq_0(self, central_freq_0):
        self.central_freq_0 = central_freq_0
        self.uhd_usrp_source_0.set_center_freq(self.central_freq_0, 0)
    ...
    def set_RX_GAIN_0(self, RX_GAIN_0):
        ...
        self.uhd_usrp_source_0.set_gain(self.RX_GAIN_0, 0)




def main(top_block_cls=RX_SIDE_4audio, options=None):
