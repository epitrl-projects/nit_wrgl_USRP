...
import tx_rx_ofdm_epy_block_0 as epy_block_0  # embedded python block
...
class tx_rx_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rate_rx = samp_rate_rx = 40000
        ...
        self.epy_block_0 = epy_block_0.pymavlink_source_sink_pp(connection_string="udp:0.0.0.0:2346", baud_rate=921600)
        ...
        self.msg_connect((self.epy_block_0, 'MAVLink_OUT'), (self.pdu_pdu_to_tagged_stream_0, 'pdus'))
