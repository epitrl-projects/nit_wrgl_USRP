...
import DONE_SIDE_epy_block_0_0 as epy_block_0_0  # embedded python block



from gnuradio import qtgui

class DONE_SIDE(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DONE_SIDE")
        ...
        self._samp_rate_range = Range(0, 500000, 1, 200000, 200)
        ...
        self.epy_block_0_0 = epy_block_0_0.pymavlink_source_sink_pp(connection_string="udp:0.0.0.0:2346", baud_rate=921600)
        ...
        self.msg_connect((self.epy_block_0_0, 'MAVLink_OUT'), (self.pdu_pdu_to_tagged_stream_0, 'pdus'))
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0, 'pdus'), (self.epy_block_0_0, 'MAVLink_IN'))
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
...
def main(top_block_cls=DONE_SIDE, options=None):
