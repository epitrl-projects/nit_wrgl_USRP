...
class simple_bpsk_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._samp_rate_range = Range(200e3, 10e6, 200e3, 200e3, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._gain_range = Range(0, 83, 1, 56, 200)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._amp_range = Range(0, 0.9, 0.005, 0.7, 200)
        ...
        self.qtgui_edit_box_msg_0 = qtgui.edit_box_msg(qtgui.STRING, 'hello', '', False, False, '', None)
