...
class rx_ofdm(gr.top_block):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_samp_rate(10000)
        ...
        self.uhd_usrp_sink_0.set_samp_rate(70000)
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.digital_constellation_decoder_cb_1, 0))
