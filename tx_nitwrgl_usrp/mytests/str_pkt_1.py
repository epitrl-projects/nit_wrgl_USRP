...
class str_pkt_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "str_pkt_1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("str_pkt_1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "str_pkt_1")
        ...
        self.uhd_usrp_source_0_0.set_samp_rate(300000)
        self.uhd_usrp_source_0_0.set_time_now(uhd.time_spec(time.time()), uhd.ALL_MBOARDS)

        self.uhd_usrp_source_0_0.set_center_freq(2000000000, 0)
        self.uhd_usrp_source_0_0.set_antenna("RX2", 0)
        self.uhd_usrp_source_0_0.set_gain(1000000000, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(2000000000, self.samp_rate)
