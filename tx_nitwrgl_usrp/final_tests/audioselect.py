...
class audioselect(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "audioselect")
        ...
        self.samp_rate_rx = samp_rate_rx = 50000
        self.samp_rate_1 = samp_rate_1 = 200000
        self.samp_rate_0 = samp_rate_0 = 30000
        ...
        self._samp_rate_1_range = Range(0, 500000, 1, 200000, 200)
        self._samp_rate_1_win = RangeWidget(self._samp_rate_1_range, self.set_samp_rate_1, "TX_SAMPLE", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._samp_rate_1_win)
        ...
        self.uhd_usrp_source_0.set_samp_rate(samp_rate_1)
        ...
        self.uhd_usrp_sink_1.set_center_freq(915e6, 0)
        self.uhd_usrp_sink_1.set_antenna("TX/RX", 0)
        self.uhd_usrp_sink_1.set_gain(10, 0)
        ...
        self.blocks_tag_debug_1 = blocks.tag_debug(gr.sizeof_char*1, 'Rx from mission planner', packet_length_tag_key)
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("msg_in"), 10)
    ...
    def set_samp_rate_1(self, samp_rate_1):
        ...
        self.uhd_usrp_source_0.set_samp_rate(self.samp_rate_1)
...
def main(top_block_cls=audioselect, options=None):
