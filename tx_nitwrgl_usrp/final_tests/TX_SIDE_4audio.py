...
import TX_SIDE_4audio_epy_block_0_0 as epy_block_0_0  # embedded python block



from gnuradio import qtgui

class TX_SIDE_4audio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TX_SIDE_4audio")
        ...
        self.qtgui_edit_box_msg_0 = qtgui.edit_box_msg(qtgui.STRING, "0", "ENTER SONG NUMBER", False, False, '', None)
        ...
        self.epy_block_0_0 = epy_block_0_0.message_to_pdu()
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_message_strobe_0, 'strobe'), (self.epy_block_0_0, 'in'))
...
def main(top_block_cls=TX_SIDE_4audio, options=None):
