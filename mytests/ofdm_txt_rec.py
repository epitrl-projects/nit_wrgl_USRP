...
class ofdm_txt_rec(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdm_txt_rec")
        ...
        self.uhd_usrp_source_1.set_center_freq(1000000000, 0)
        self.uhd_usrp_source_1.set_antenna("TX/RX", 0)
        self.uhd_usrp_source_1.set_gain(10000, 0)
        ...
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            log=False,
            truncate=False)
        self.blocks_throttle_2 = blocks.throttle(gr.sizeof_gr_complex*1, 1000000,True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, 1000000,True)
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_char*1, 'Rx_packets', '')
        ...
        self.connect((self.digital_ofdm_rx_0, 0), (self.digital_constellation_modulator_0, 0))
        self.connect((self.uhd_usrp_source_1, 0), (self.analog_agc3_xx_0, 0))
        self.connect((self.uhd_usrp_source_1, 0), (self.blocks_throttle_2, 0))
...
def main(top_block_cls=ofdm_txt_rec, options=None):
