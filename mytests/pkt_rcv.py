...
class pkt_rcv(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_center_freq(2000000000, 0)
        self.uhd_usrp_source_0.set_antenna("RX2", 0)
        self.uhd_usrp_source_0.set_gain(1000000000, 0)
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.mmse_resampler_xx_0, 0))
